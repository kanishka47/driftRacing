      ...
      <footer class="page-footer font-small indigo pt-0">
          ...
          <div class="container">
              ...
              <div class="row pt-5 mb-3 text-center d-flex justify-content-center">
                  ...
                  <!--Grid column-->
                  <div class="col-md-2 mb-3">
                      <h6 class="title font-weight-bold"><a href="#!">Team</a></h6>
                  </div>
                  <!--Grid column-->
      
                  <!--Grid column-->
                  <div class="col-md-2 mb-3">
                      <h6 class="title font-weight-bold"><a href="#!">Sponsors</a></h6>
                  </div>
                  <!--Grid column-->
      
                  <!--Grid column-->
                  <div class="col-md-2 mb-3">
                      <h6 class="title font-weight-bold"><a href="#!">Gallery</a></h6>
                  </div>
                  <!--Grid column-->
          ...
          <div class="footer-copyright py-3 text-center">
              <div class="container-fluid">
                  © 2018 Copyright: <a href="https://mdbootstrap.com/material-design-for-bootstrap/"> driftracing </a>
              </div>
          </div>
          <!--/Copyright-->
